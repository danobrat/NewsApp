    ...
    private static List<NewsArticle> extractFeatureFromJson(String newsArticleJSON) {
        ...
        try {
            ...
            for (int i = 0; i < featureArray.length(); i++) {
                ...
                String eventName = currentNews.getString("sectionName");
                String eventTitle = currentNews.getString("webTitle");
                long eventDate = currentNews.getLong("webPublicationDate");
                String url = currentNews.getString("webUrl");

                // Create a new {@link Earthquake} object with the magnitude, location, time,
                // and url from the JSON response.
                NewsArticle newsarticle = new NewsArticle(eventName, eventTitle, eventDate, url);
